...
<form action="<?php echo JRoute::_('index.php?option=com_gcmserver&view=profiles'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<thead>
					<tr>
                        ...
                        <th width="10%" class="nowrap hidden-phone">
							<?php echo JHtml::_('searchtools.sort', 'COM_GCMSERVER_TITLE_CREATED', 'a.created', $listDirn, $listOrder); ?>
						</th>
...
$link 		= JRoute::_( 'index.php?option=com_gcmserver&task=profile.edit&id='.(int) $item->id);	
        ...
        <tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
			...
			<td>
				...
				<span class="editlinktip hasTooltip" title="<?php echo JText::_( 'COM_GCMSERVER_EDIT_PROFILE' );?>">
