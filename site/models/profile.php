...
class GcmserverModelProfile extends JModelForm
{
	public $_context = 'com_gcmserver.profile';
...
protected function populateState()
	...
	{	
		...
		$row = JTable::getInstance('profiles', 'GcmserverTable');			
		if (!$row->bind($data)) {
